...
const Page = () => {
  ...
  return (
    <div>
      <div className='mt-24 flex justify-center gap-10 items-center align-middle'>
        <Input
          id="picture"
          type="file"
          className="w-full max-w-xs border border-[#10847E] p-2"
          onChange={handleFileChange}
        />
        <Button type="submit" className="bg-[#10847E]" onClick={handleSummarizeClick}>Upload</Button>
        <Drawer>
          <DrawerTrigger className='bg-[#10847E] text-white p-2 border rounded-md'>Summarize</DrawerTrigger>
          <DrawerContent>
            <DrawerHeader>
              <DrawerTitle>Summary Of Your Report</DrawerTitle>
            </DrawerHeader>
            <div className='p-10'>
              {summary}
            </div>
