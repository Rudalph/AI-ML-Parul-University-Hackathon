  ...
  return (
    <div>
      ...
      <div className='mt-40 flex justify-evenly'>
        <div className="card card-compact w-96 bg-base-100 shadow-xl ml-5 rounded-sm">
          <div className="card-body m-5">
            <h2 className="card-title justify-center">Basic Information</h2>
            <div className='p-5'>
        ...
        <div className="card card-compact w-96 bg-base-100 shadow-xl ml-5 rounded-sm">
          <div className="card-body m-5">
            <h2 className="card-title justify-center">Physical Attributes</h2>
            <div className='p-5'>
        ...
        <div className="card card-compact w-96 bg-base-100 shadow-xl ml-5 rounded-sm">
          <div className="card-body m-5">
            <h2 className="card-title justify-center">Medical History</h2>
            <div className='p-5'>
      ...
      <div className='mt-10 mb-10 flex justify-evenly'>
        <div className="card card-compact w-96 bg-base-100 shadow-xl ml-5 rounded-sm">
          <div className="card-body m-5">
            <h2 className="card-title justify-center">Diatery Habits</h2>
            <div className='p-5'>
        ...
        <div className="card card-compact w-96 bg-base-100 shadow-xl ml-5 rounded-sm">
          <div className="card-body m-5">
            <h2 className="card-title justify-center">Health Goals</h2>
            <div className='p-5'>
              <Input type="text" name="weightGoal" placeholder="Weight Loss/Gain/Maintain" onChange={handleChange} />
              <br />
              <Input type="text" name="targetWeight" placeholder="Target Weight" onChange={handleChange} />
              <br />
              <Input type="text" name="fitnessGoals" placeholder="Fintness Goals" onChange={handleChange} />
              <br />
              <Input type="text" name="healthImprovements" placeholder="Health Improvements" onChange={handleChange} />
            </div>
          </div>
        </div>
        ...
        <div className="card card-compact w-96 bg-base-100 shadow-xl ml-5 rounded-sm">
          <div className="card-body m-5">
            <h2 className="card-title justify-center">Life Style Factor</h2>
            <div className='p-5'>
        ...
        <Drawer>
          ...
          <DrawerContent>
            <div className="mx-auto w-full">
              <DrawerHeader>
                <DrawerTitle className="flex justify-center align-middle items-center"><strong>Advice</strong></DrawerTitle>
