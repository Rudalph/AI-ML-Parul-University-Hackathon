...
export default function ExampleNavbarOne() {
  ...
  return (
    <div className="fixed top-0 z-50 w-full bg-white hover:shadow-xl">
      <div className="mx-auto flex items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
        <div className="inline-flex items-center space-x-2">
          <span>
              <Image src={"/wired-flat-49-plus-circle.gif"}
              height={60}
              width={60}
              />
          </span>
          <h1><span className="font-bold text-[#10847E]">Swasthya Connect</span></h1>
        </div>
        ...
        <div className="hidden lg:block">
          ...
          <div className="absolute bottom-0 left-0 w-full h-0.5 bg-[#E8E8E8]"></div>
        </div>
